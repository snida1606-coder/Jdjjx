...
def login():
    for attempt in range(1, 21):
        ...
        try:
            ...
            if not tok:
                print("  No CSRF, trying API..."); time.sleep(3); continue
            time.sleep(2)
            r4 = s.post(f"{BASE_DOMAIN}/pt/sign-in/", data={"_token": tok, "email": EMAIL, "password": PASSWORD, "remember": 1}, timeout=30)
